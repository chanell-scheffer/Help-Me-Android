...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       moreInformation = (TextView) findViewById(R.id.moreInfo);
        moreInformation.setText("https://www.wolframalpha.com/");
        Linkify.addLinks(moreInformation, Linkify.WEB_URLS);
